...
auto covert_real_to_cachable_syscall(State &, Syscall_read const &) -> CachedSyscall_Read;
auto covert_real_to_cachable_syscall(State &, Syscall_pread64 const &) -> CachedSyscall_Read;
} // namespace gpcache
