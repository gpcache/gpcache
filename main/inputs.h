...
using CachedSyscall =
    std::variant<CachedSyscall_Access, CachedSyscall_Close, CachedSyscall_Fstat, CachedSyscall_Mmap, CachedSyscall_Open,
                 CachedSyscall_Read, CachedSyscall_Write, FileHash, ParamsInput, UnsupportedInput>;
