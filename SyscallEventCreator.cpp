...
namespace gpcache
{
  ...
  auto createEvent(SyscallDataType syscall_id, SyscallDataType arg1, SyscallDataType arg2, SyscallDataType arg3, SyscallDataType arg4, SyscallDataType arg5, SyscallDataType arg6) -> SyscallEvent
  {
    ...
    case 209: 
      return Event_io_submit
      {
      .unnamed0 = static_cast<aio_context_t>(arg1),
      .unnamed1 = static_cast<long>(arg2),
      .unnamed2 = reinterpret_cast< iocb * *>(arg3),
      };
    case 210: 
      return Event_io_cancel
      {
      .ctx_id = static_cast<aio_context_t>(arg1),
      .iocb = reinterpret_cast< iocb *>(arg2),
      .result = reinterpret_cast< io_event *>(arg3),
      };
    case 212: 
    ...
    case 281: 
      ...
      .maxevents = static_cast<int>(arg3),
      .timeout = static_cast<int>(arg4),
      .sigmask = reinterpret_cast<const sigset_t *>(arg5),
